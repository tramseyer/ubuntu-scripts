...
if dpkg --print-architecture | grep amd64; then
    wget -nv --backups=0 https://archive.ubuntu.com/ubuntu/pool/universe/n/ncurses/libncursesw5_6.3-2ubuntu0.3_amd64.deb
    wget -nv --backups=0 https://archive.ubuntu.com/ubuntu/pool/universe/n/ncurses/libtinfo5_6.3-2ubuntu0.3_amd64.deb
    dpkg-deb -xv libncursesw5_6.3-2ubuntu0.3_amd64.deb libncursesw5
    dpkg-deb -xv libtinfo5_6.3-2ubuntu0.3_amd64.deb libtinfo5
...
if [ ! -z "$PT_LINUX_ARCH" ]; then
    ...
    TERM=xterm LD_LIBRARY_PATH="$(pwd)" "./PerformanceTest_Linux_$PT_LINUX_ARCH" -r 1
